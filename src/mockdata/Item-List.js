const items = [
    {
        id: 0,
        content: "OpenGLRenderer.mp4",
        contentType: "video",
        alt: "OpenGL Renderer",
        category: "cs",
        skills: ["C++", "vscode", "bash"],
        description: "A renderer implemented in C++ using OpenGL. Models imported using Assimp. Both models shown are not mine, but are publicly available. I plan to add model editing and sculpting in the future. I will be using this project to learn graphics APIs and imporve my optimization skills.",
    },
    {
        id: 1,
    ...
    // },
    {
        ...
        content: "guitar.mp4",
        contentType: "video",
        alt: "Guitar Turnaround",
        category: "art",
        skills: ["blender"],
        description: "Guitar modeled and textured from scratch in blender.",
    },
    {
        id: 20,
    ...
    {
        id: 21,
        content: "FightingGameCharacter.mp4",
        contentType: "video",
        alt: "Fighting Game Turnaround",
        category: "art",
        skills: ["blender"],
        description: "Character modeled, textured, rigged and animated in blender. Exported into Unreal engine for my personal project",
    },
    {
        id: 22,
        content: "austin.mp4",
        ...
        category: "art",
        skills: ["blender"],
        description: "I modeled, and sculpted myself in blender. I started by pulling in a gaussian splat of myself by taking multiple pictures around me.",
    },
    {
        id: 23,
        content: "Emily_L.mp4",
        contentType: "video",
        alt: "Emily Turnaround",
        category: "art",
        skills: ["blender"],
        description: "Modeled and sculpted in blender.",
    },
    {
        id: 24,
        content: "Beckett.mp4",
        contentType: "video",
        alt: "Beckett Turnaround",
        category: "art",
        skills: ["blender"],
        description: "Modeled and sculpted in blender.",
    },
    {
        id: 25,
        content: "EloiseClay.mp4",
        contentType: "video",
        alt: "Eloise Turnaround",
        category: "art",
        skills: ["blender"],
        description: "Modeled and sculpted in blender.",
    },
